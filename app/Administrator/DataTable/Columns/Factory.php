...
namespace App\Administrator\DataTable\Columns;

use App\Administrator\Validator;
use App\Administrator\Config\ConfigInterface;
use Illuminate\Database\DatabaseManager as DB;
use App\Administrator\DataTable\Columns\Relationships\BelongsTo;
use App\Administrator\DataTable\Columns\Relationships\BelongsToMany;
...
class Factory
{
     ...
     * @param array $options
     *
     * @return \App\Administrator\DataTable\Columns\Column
     */
    ...
    public function getIncludedColumns(array $fields)
    {
        ...
        if (empty($this->includedColumns)) {
            ...
            foreach ($fields as $field) {
                if (is_a($field, 'App\\Administrator\\Fields\\Relationships\\BelongsTo')) {

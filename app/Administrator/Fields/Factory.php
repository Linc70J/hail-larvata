...
namespace App\Administrator\Fields;

use App\Administrator\Validator;
use App\Administrator\Config\ConfigInterface;
...
class Factory
{
    ...
    protected $fieldTypes = array(
        'key'      => 'App\\Administrator\\Fields\\Key',
        'text'     => 'App\\Administrator\\Fields\\Text',
        'textarea' => 'App\\Administrator\\Fields\\Text',
        'wysiwyg'  => 'App\\Administrator\\Fields\\Text',
        'markdown' => 'App\\Administrator\\Fields\\Text',
        'password' => 'App\\Administrator\\Fields\\Password',
        'date'     => 'App\\Administrator\\Fields\\Time',
        'time'     => 'App\\Administrator\\Fields\\Time',
        'datetime' => 'App\\Administrator\\Fields\\Time',
        'number'   => 'App\\Administrator\\Fields\\Number',
        'bool'     => 'App\\Administrator\\Fields\\Boolean',
        'enum'     => 'App\\Administrator\\Fields\\Enum',
        'image'    => 'App\\Administrator\\Fields\\Image',
        'file'     => 'App\\Administrator\\Fields\\File',
        'color'    => 'App\\Administrator\\Fields\\Color',

        //relationships
        'belongs_to'      => 'App\\Administrator\\Fields\\Relationships\\BelongsTo',
        'belongs_to_many' => 'App\\Administrator\\Fields\\Relationships\\BelongsToMany',
        'has_one'         => 'App\\Administrator\\Fields\\Relationships\\HasOne',
        'has_many'        => 'App\\Administrator\\Fields\\Relationships\\HasMany',
     ...
     *
     * @var \App\Administrator\Validator
     */
    protected $validator;
     ...
     *
     * @var \App\Administrator\Config\ConfigInterface
     */
    protected $config;
     ...
     *
     * @param \App\Administrator\Validator              $validator
     * @param \App\Administrator\Config\ConfigInterface $config
     ...
     *
     * @return App\Administrator\Fields\Field
     */
    ...
    public function getRelationshipKey($field)
    {
        ...
        if (is_a($related_model, $this->relationshipBase.'BelongsTo')) {
            return 'belongs_to';
        } elseif (is_a($related_model, $this->relationshipBase.'BelongsToMany')) {
            return 'belongs_to_many';
        } elseif (is_a($related_model, $this->relationshipBase.'HasOne')) {
            return 'has_one';
        } elseif (is_a($related_model, $this->relationshipBase.'HasMany')) {
            return 'has_many';
        } else {
            throw $invalidArgument;
        }
     ...
     * @param \App\Administrator\Fields\Field $fieldObject
     ...
     *
     * @param \App\Administrator\Fields\Field   $field

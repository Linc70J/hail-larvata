<h2><?php echo trans('administrator.filters') ?></h2>
<div class="filters">
	...
	<!-- ko foreach: $root.filters -->
		<!-- ko if: visible -->
            ...
            <div class="form-inline">
				...
				<input type="text" class="form-control" data-bind="value: min_value, attr: {id: field_id + '_min'}, number: {decimals: decimals, key: field_name,
																						thousandsSeparator: thousands_separator,
																						decimalSeparator: decimal_separator}" />
				<span>-</span>
				<input type="text" class="form-control" data-bind="value: max_value, attr: {id: field_id + '_max'}, number: {decimals: decimals, key: field_name,
																						thousandsSeparator: thousands_separator,
																						decimalSeparator: decimal_separator}" />
            </div>
			<!-- /ko -->
			...
			<!-- ko if: type === 'date' -->
            <div class="form-inline">
				<input type="text" class="form-control" data-bind="value: min_value, attr: {id: field_id + '_min'}, datepicker: {dateFormat: date_format}" />
				<span>-</span>
				<input type="text" class="form-control" data-bind="value: max_value, attr: {id: field_id + '_max'}, datepicker: {dateFormat: date_format}" />
            </div>
			<!-- /ko -->

			<!-- ko if: type === 'time' -->
            <div class="form-inline">
				<input type="text" class="form-control" data-bind="value: min_value, attr: {id: field_id + '_min'}, timepicker: {timeFormat: time_format}" />
				<span>-</span>
				<input type="text" class="form-control" data-bind="value: max_value, attr: {id: field_id + '_max'}, timepicker: {timeFormat: time_format}" />
            </div>
			<!-- /ko -->

			<!-- ko if: type === 'datetime' -->
            <div class="form-inline">
				<input type="text" class="form-control" data-bind="value: min_value, attr: {id: field_id + '_min'},
																		datetimepicker: {dateFormat: date_format, timeFormat: time_format}" />
				<span>-</span>
				<input type="text" class="form-control" data-bind="value: max_value, attr: {id: field_id + '_max'},
																		datetimepicker: {dateFormat: date_format, timeFormat: time_format}" />
            </div>
			<!-- /ko -->

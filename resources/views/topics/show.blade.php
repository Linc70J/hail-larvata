...
{{--    </div>--}}
    ...
    <div class="col-lg-offset-1 col-md-offset-1 col-lg-10 col-md-10 col-sm-12 col-xs-12 topic-content">
        <div class="panel panel-default">
            <div class="panel-body">
        ...
        <div class="panel panel-default topic-reply">
            <div class="panel-body">
                ...
                @include('topics._reply_list', ['replies' => $topic->topicReplies()->with('user')->get()])
            </div>
        </div>
    </div>
</div>
